...
experiment_name = "SIC_Attention_Res_UNet_without_TOPAZ"
lead_time = 0
#
...
list_predictors = ["LSM", "ECMWF_T2M_cum", "ECMWF_wind_x_cum", "ECMWF_wind_y_cum", "SICobs_AMSR2_SIC", "SICobs_AMSR2_trend"]
