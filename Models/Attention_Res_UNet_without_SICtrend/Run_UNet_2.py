...
experiment_name = "SIC_Attention_Res_UNet_without_SICtrend"
lead_time = 2
#
...
list_predictors = ["LSM", "TOPAZ_SIC", "ECMWF_T2M_cum", "ECMWF_wind_x_cum", "ECMWF_wind_y_cum", "initial_bias", "SICobs_AMSR2_SIC"]
