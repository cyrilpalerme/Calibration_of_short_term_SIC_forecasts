...
experiment_name = "SIC_Attention_Res_UNet_without_T2m"
lead_time = 6
#
...
list_predictors = ["LSM", "TOPAZ_SIC", "ECMWF_wind_x_cum", "ECMWF_wind_y_cum", "initial_bias", "SICobs_AMSR2_SIC", "SICobs_AMSR2_trend"]
